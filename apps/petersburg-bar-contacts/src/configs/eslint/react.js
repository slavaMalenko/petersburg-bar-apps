module.exports = {
     ...
     */
    'react/jsx-sort-props': [2, { ignoreCase: true, shorthandFirst: true, callbacksLast: true, reservedFirst: true }],
    ...
    // Для поддержки нового способа трансформации React.JSX - react-jsx
    ...
    /**
     * Отключаем правило, так как версия реакт >18
     */
